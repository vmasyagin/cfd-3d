...
class LimiterCockburn : public Limiter
{
public:
	LimiterCockburn(FEM_DG *mthd, Grid *grid, double **ro, double **ru, double **rv, double **rw, double **re, int fCount);
	virtual ~LimiterCockburn();
	virtual void run();
...
private:
	...
	const double LIMITER_ALPHA = 1.5;
